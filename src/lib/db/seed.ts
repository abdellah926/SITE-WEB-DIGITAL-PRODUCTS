  ...
  await db.insert(products).values([
    {
      ...
      priceMAD: 54,
      priceUSD: 499,
      images: ["/img/shop/cyrus-reference-11.png", "/img/shop/cyrus-reference-10.png", "/img/shop/by-cyrus-1.jpg"],
    ...
    },
    {
      ...
      priceMAD: 43,
      priceUSD: 399,
      images: ["/img/shop/cyrus-reference-9.png", "/img/shop/cyrus-reference-8.png", "/img/shop/by-cyrus-3.jpg", "/img/shop/by-cyrus-4.jpg"],
    ...
    },
    {
      ...
      priceMAD: 86,
      priceUSD: 799,
      images: ["/img/shop/cyrus-reference-7.png", "/img/shop/by-cyrus-5.jpg", "/img/shop/by-cyrus-2.jpg", "/img/shop/cyrus-reference-6.png"],
    ...
    {
      slug: "crochet-patterns-bundle",
      title: "باقة باترونات الكروشي الكاملة PDF",
      titleFr: "Pack complet de patrons crochet (PDF)",
      titleEn: "Complete Crochet Patterns Bundle – PDF",
      description:
        "كل الباترونات الخمسة في باقة واحدة بسعر مميز: البطانية، الدمية، الوشاح، السلة، ودليل المبتدئ. تحميل فوري بعد الدفع.",
      descriptionFr:
        "Tous les 5 patrons en un seul pack à prix avantageux : couverture, poupée, écharpe, panier et guide du débutant. Téléchargement instantané après paiement.",
      descriptionEn:
        "All 5 patterns in one special-price bundle: Afghan blanket, amigurumi doll, wool scarf, storage basket, and the beginner's guide. Save money and get instant PDF downloads after payment.",
      priceMAD: 193,
      priceUSD: 1999,
      images: ["/img/shop/by-cyrus-12.jpg"],
      categoryId: bySlug["kits"],
      inStock: true,
      featured: true,
      fileKey: "crochet-bundle.pdf",
      fileMime: "application/pdf",
    },
  ]);
