...
('What verification means', 'The stitch sequences have been checked for arithmetic consistency. This does not verify shape, fit, yarn quantity or usability. A crocheter must make every variant, record corrections and photograph the finished sample before a customer edition is released.')]
...
def dollbase():
    ...
    a += [p('Doll legs and arms','Heading1')]+roundtable('Legs: make two',LEGS)+[p('Stuff the boot firmly and upper leg moderately. Leave top open with a sewing tail. R1-R6 form the boot; R7-R12 form the leg. Sew each leg top to the underside of the body with boots facing forward.')]+roundtable('Arms: make two',ARMS)+[p('Use skin for R1-R5 and sleeve colour for R6-R12 unless the variant says otherwise. Stuff only the hand. Flatten the 6-stitch opening and sew across 3 paired stitches. Attach at body R15, one on each side.'),PageBreak()]
...
('Open-front jacket','Ch 33; Row 1: sc in second ch and across (32). Rows 2-7: 32 sc. Row 8: 6 sc, ch 4, skip 4, 12 sc, ch 4, skip 4, 6 sc (24 sc + 8 ch). Row 9: 32 sc, working one into each ch. Row 10: 32 sc. Fit around the body with openings at the arms; front edges stay open. Sew shoulders if needed, without closing armholes. For sleeves, join yarn in an armhole and work 4 sc across its lower edge, 1 into side row-end, 4 across its top, 1 into other side (10). Work 4 further rounds of 10 sc; fasten off. Repeat.'),
...
('Front legs - make two','Cream: MR 6; R2 inc x 6 (12); R3-R5 12 sc; R6 (2 sc, dec) x 3 (9). Change to grey; R7-R13 9 sc. Stuff lower half. Flatten and sew closed across the opening. Sew upper ends at body R14, with paws resting below body R4. Embroider two charcoal toe lines on each paw.'),
...
('Eye patches and ears','Patches, make two: black MR 6; R2 inc x 6 (12); fasten off and flatten. Sew at head R8-R11 with about 4 sts between patches. Embroider white eye highlights. Ears, make two: black MR 6; R2 inc x 6 (12); R3 12 sc. Flatten without stuffing and sew lower edge onto head R3-R5. Embroider nose and mouth between patches.'),
('Four paws','Black MR 6; R2 (sc, inc) x 3 (9); R3-R5 9 sc. Stuff tips lightly, flatten opening and sew closed. Attach two at body R9 as arms, two at body R3-R4 as feet. White tail: MR 6, then 6 sc; close and sew to body back R4.')])
...
('Small padded paw','MR 6; R2 (sc, inc) x 3 (9); R3-R4 9 sc. Add a pinch of stuffing, flatten open edge and seam shut. Make two in design colour. Sew all around outer edge so paws do not swing.'),
...
('Make pieces','Make two grey triangle ears with pink inner triangles, two cream padded paws and 4 grey small round patches. Make a tail: charcoal MR 6; work 14 more rounds of 6 sc, changing to grey for R3-R5, R8-R10 and R13-R15. Stuff lightly; flatten opening and sew closed.'),
...
f1='01_Characters_and_Dolls_TEST_DRAFT_v0.1.pdf'
f2='02_Phone_Covers_TEST_DRAFT_v0.1.pdf'
f3='03_Beginner_Cat_and_Panda_TEST_DRAFT_v0.1.pdf'
f4='04_Complete_Collection_TEST_DRAFT_v0.1.pdf'
...
intro=OUT/'qa'/'bundle-intro.pdf'
build('qa/bundle-intro.pdf','Complete Collection - TEST DRAFT',cover('COLLECTION 04','Complete Collection','Nine development designs in three collections','Part 1: Characters & Dolls (3) | Part 2: Phone Covers (4) | Part 3: Cat & Panda (2)')+page('Bundle scope and navigation',[
...
writer.add_metadata({'/Title':'Complete Collection - Nine Designs - TEST DRAFT v0.1','/Author':'Crochet & Handmade'})
